...
fn add_price_update<'a>(graph: &'a mut GraphType<'a>, index_map: &mut IndexHashMap<(String, String)>, price_update: PriceUpdate) {
...
fn handle_command<'a>(graph: &mut GraphType<'a>, index_map: &mut IndexHashMap<(String, String)>, parsed_line: ParsedLine) {
